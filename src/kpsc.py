...
if __name__=='__main__':
    ...
    train_dataset = datasets.MILTensorDataset(train_data['X'], train_data['lengths'], train_data['y'][:,1][:,None])
    val_dataset = datasets.MILTensorDataset(val_data['X'], val_data['lengths'], val_data['y'][:,1][:,None])
    test_dataset = datasets.MILTensorDataset(test_data['X'], test_data['lengths'], test_data['y'][:,1][:,None])
