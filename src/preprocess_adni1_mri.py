...
# python ../src/preprocess_adni1_mri.py --csv_filename='ADNI1_Complete_1Yr_1.5T.csv' --nifti_dir='/cluster/tufts/hugheslab/datasets/ADNI1_Complete_1Yr_1.5T' --numpy_dir='/cluster/tufts/hugheslab/datasets/ADNI1_Complete_1Yr_1.5T_numpy' --start=0 --stop=2294
