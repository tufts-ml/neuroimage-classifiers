...
# Full hyperparameter sweep for each neighbor value for OASIS-3 CT experiments
...
dataset_dir="/cluster/tufts/hugheslab/eharve06/encoded_OASIS-3_CT/ViT_B_16/seed=${seed}"
experiments_dir="/cluster/tufts/hugheslab/dloevl01/Dec_2025/pooling/experiments/oasis-3_ct/neighbors=${neighbors}/${approach}"
